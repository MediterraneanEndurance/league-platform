...
export function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-lg border border-white/10 bg-zinc-950/75 p-5 shadow-2xl shadow-black/20 transition duration-200",
        className,
      )}
    >
      {children}
...
export function SectionHeader({
  ...
  return (
    <div className="mb-6 max-w-3xl">
      {eyebrow ? (
        <p className="mb-2 text-xs font-bold uppercase tracking-[0.32em] text-cyan-300">{eyebrow}</p>
      ) : null}
